                      ...
                      <div className="card-body">
                        ...
                        <div className="personal-activity">
                          <div className="personal-icons status-grey">
                            <img src="assets/img/icons/medal-01.svg" alt="m" />
                          </div>
                        ...
                        <div className="personal-activity">
                          <div className="personal-icons status-green">
                            <img src="assets/img/icons/medal-02.svg" alt="m" />
                          </div>
                          <div className="views-personal">
                            <h4>Certified</h4>
                        ...
                        <div className="personal-activity mb-0">
                          <div className="personal-icons status-orange">
                            <img src="assets/img/icons/medal-03.svg" alt="m" />
                          </div>
                          <div className="views-personal">
                              ...
                              <div className="detail-personal">
                                ...
                                <h3>
                                  <a
                                    ...
                                    data-cfemail="aac8d8dfc9cfeacfc7cbc3c684c9c5c7"
                                  >
                                    [email&#160;protected]
                                  </a>
                                </h3>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-body text-center">
              <img src="assets/img/sent.png" alt="m" width="50" height="46" />
